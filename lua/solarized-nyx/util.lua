local ts = require("solarized-nyx.treesitter")
...
function M.invert_color(color)
  local hsluv = require("solarized-nyx.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("solarized-nyx", { clear = true })
...
function M.load(theme)
  ...
  vim.g.colors_name = "solarized-nyx"
