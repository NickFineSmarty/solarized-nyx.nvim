...
local colors = require("solarized-nyx.colors")
...
---@return Theme
function M.setup()
  local config = require("solarized-nyx.config")
  ...
  theme.highlights = {
    ...
    MatchParen = { fg = c.blue700, bg = c.blue500, bold = true }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    FloatBorder = { fg = c.blue700, bg = c.bg_float },
    ...
    PreProc = { fg = c.blue700 }, -- (preferred) generic Preprocessor
    ...
    NvimTreeGitDirty = { fg = c.blue500 },
    NvimTreeGitNew = { fg = c.green500 },
    NvimTreeGitDeleted = { fg = c.blue700 },
